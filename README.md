...
**[v0.1.11](https://github.com/stoatworks-labs/vectrix/releases/tag/v0.1.11)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`vectrix-0.1.11-macos-universal.dmg`](https://github.com/stoatworks-labs/vectrix/releases/download/v0.1.11/vectrix-0.1.11-macos-universal.dmg) | 2.1 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`vectrix-0.1.11-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/vectrix/releases/download/v0.1.11/vectrix-0.1.11-windows-x86_64-setup.exe) | 476 KB |
